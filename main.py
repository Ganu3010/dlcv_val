...
def train_Unet_DDPM(epochs, lr, MODEL_PATH, data_path, betas = (0.9, 0.99), chkpt = 100):
    ...
    np.save(os.path.join(MODEL_PATH, 'history.npy'), np.array(history))
    print(F"Model trained. \nCheckpoints and history saved at: {MODEL_PATH}")

def sample_Unet_DDPM(model_path, output_path, image_size = 64, batch_size = 1):
    ...
    output = diffusion.sample(batch_size = batch_size)
...
if __name__=='__main__':
    ...
    train_Unet_DDPM(100, 8e-5, 'model_trial', 'dataset/images.npy', chkpt=10)